...
def draw_tick_population(tick_list, white_num_list, black_num_list, dir_name):
    # plt.figure(figsize=(10, 10))
    plt.plot(tick_list, white_num_list, color='blue', label='white daisies population')
    plt.plot(tick_list, black_num_list, color='black', label='black daisies population')
    plt.legend()
